        ...
        {activeTab === 'pending' ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            {pendingRequests.map((biz) => (
              <div key={biz.id} className="bg-[#F9F7F2] p-6 lg:p-8 border border-[#E5E1D8] flex flex-col group hover:border-brand-primary transition-all">
                <div className="flex justify-between items-start mb-6 lg:mb-8 gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-black text-sm lg:text-lg text-brand-primary uppercase tracking-tight">{biz.name}</h4>
                  ...
                  <div className="bg-white px-3 lg:px-4 py-1.5 lg:py-2 border border-gray-100 shadow-sm shrink-0 text-right">
                    ...
                    <p className="text-xs lg:text-sm font-black text-brand-primary">₹{biz.incentive}</p>
                  </div>
                </div>
